...
class GetFileShare extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      filename: "",
  ...
  downloadEmployeeData = async (e) => {
    ...
    console.log(data);
    await axios.post("http://localhost:5000/getFile", data).then((response) => {
    ...
    return (
      <div id="container">
        ...
        <input
          ...
          name="path"
          onChange={this.handleOnChangePath}
        />
