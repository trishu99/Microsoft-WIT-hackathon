          ...
          <Terminal
            commandPassThrough={(cmd, print) => {
              ...
              if (cmd[0] == "path") {
                ...
                var path = "";
                axios
                  .post("http://localhost:5000/shell", data)
                  .then((response) => {
                ...
                axios
                  .post("http://localhost:5000/shell", filename)
                  .then((response) => {
                    // print(response.data.join('\n'));
                    path += response.data;
                    // console.log(path);
                ...
                axios.post("");
                axios
                  .post("http://localhost:5000/getFile", data)
                  .then((response) => {
                ...
                axios.post("");
                axios
                  .post("http://localhost:5000/changedir", data)
                  .then((response) => {
                    {
                      this.changedir();
                    }
