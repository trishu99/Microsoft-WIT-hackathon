...
class Run extends React.Component {
  ...
  StartProgram = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/startprocess", data)
      .then((response) => {
  ...
  StartProgramAfterTime = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/startprocessaftermins", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  StartProgramAtTime = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/startprocessattime", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  checkprocess = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/checkprocess", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  sendsignal = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/sendsignal", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  downloadEmployeeData = async (e) => {
    ...
    console.log(data);
    await axios
      .post("http://localhost:5000/terminateprocess", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  shutdownnow = async (e) => {
    ...
    await axios.post("http://localhost:5000/shutdownnow").then((response) => {
      console.log(response);
      this.setState({
        sdnow: response.data,
      });
  ...
  shutdownaftergivenmin = async (e) => {
    ...
    await axios
      .post("http://localhost:5000/shutdownaftermin", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  shutdownattime = async (e) => {
    ...
    console.log("shutdown after min");
    await axios
      .post("http://localhost:5000/shutdownattime", data)
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  shutdowncancel = async (e) => {
    ...
    await axios
      .post("http://localhost:5000/cancelshutdown")
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  restartsystem = async (e) => {
    console.log("restart");
    await axios.post("http://localhost:5000/restartsystem").then((response) => {
      console.log(response);
      this.setState({
  ...
  rebootsystem = async (e) => {
    console.log("reboot");
    await axios.post("http://localhost:5000/rebootsystem").then((response) => {
      console.log(response);
      this.setState({
  ...
  suspendsystem = async (e) => {
    console.log("suspend");
    await axios.post("http://localhost:5000/suspendsystem").then((response) => {
      console.log(response);
      this.setState({
  ...
  hibernatesystem = async (e) => {
    ...
    await axios
      .post("http://localhost:5000/hibernatesystem")
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  screenlocksystem = async (e) => {
    ...
    await axios
      .post("http://localhost:5000/screenlocksystem")
      .then((response) => {
        console.log(response);
        this.setState({
  ...
  logoutsystem = async (e) => {
    console.log("logout");
    await axios.post("http://localhost:5000/logoutsystem").then((response) => {
      console.log(response);
      this.setState({
      ...
      <div id="container">
        ...
        <center>
          ...
          <input
            ...
            name="shutdownaftermin"
            onChange={this.handleChange}
          />
          <button onClick={this.shutdownaftergivenmin}>
            shutdown after mins
          </button>
          ...
          <button onClick={this.hibernatesystem}>
            place system in hibernate mode
          </button>
          ...
          <h6>
            (suffix the time with m for mins, s for secs , h for hours, d for
            days)
          </h6>
          <label>Program Name</label>
          <input
            type="text"
            value={this.state.programnameforaftertime}
            name="programnameforaftertime"
            onChange={this.handleChange}
          />
          <br />
          <label>Time </label>
          ...
          <h1>
            Start processes at time in (mm/dd/yyyy 24hr format:time) format
          </h1>
          <h6>(give time in 24 hr format)</h6>
          <label>Program Name</label>
          <input
            type="text"
            value={this.state.programnameforattime}
            name="programnameforattime"
            onChange={this.handleChange}
          />
          <br />
          ...
          <br />
          <br />
          <button onClick={this.downloadEmployeeData}>Stop or Terminate</button>
          <br />
          ...
          <input
            type="text"
            value={this.state.processnameforcheck}
            name="processnameforcheck"
            onChange={this.handleChange}
          />
          <br />
          <br />
